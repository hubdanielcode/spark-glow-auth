...
export default function AdminReports() {
  ...
  const cards = [
    ...
    },
    {
      ...
      value: stats ? `R$ ${stats.monthlyRevenue.toFixed(2).replace('.', ',')}` : '—',
      icon: TrendingUp,
    ...
    },
    {
      ...
      icon: Package,
      description: stats?.lowStock ? `${stats.lowStock} com estoque baixo` : 'Estoque ok',
    },
  ];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Visão geral do desempenho da loja</p>
      </div>
